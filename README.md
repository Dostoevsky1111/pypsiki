...
Приложение для классификации радиосигналов инопланетных цивилизаций с использованием нейронной сети. Разработано в рамках олимпиады МПОШ 2226 года.
...
В 2226 году человечество установило контакт с множеством инопланетных цивилизаций. Этот проект помогает учёному Михаилу автоматически определять, какая именно цивилизация отправила радиосигнал, по его записи.

**Основные задачи:**
1. 🔧 Восстановление повреждённых обозначений классов в обучающей выборке.
2. 🧠 Обучение нейронной сети для классификации сигналов (использование готовых моделей запрещено).
3. 🖥️ Разработка веб-приложения с графическим интерфейсом и системой авторизации.
...
- Хэширование паролей с солью (MD5/SHA-256).
...
🗄️ База данных
├── SQLite (локальная разработка) / PostgreSQL (продакшен)
...
2. Введите учётные данные:
   - **Администратор (по умолчанию)**:  
     `admin / admin123` *(рекомендуется сменить пароль после первого входа!)*
...
- Новый пользователь появится в базе и сможет авторизоваться.
...
3. **Результаты**
   - Отображаются точность (`accuracy`) и потери (`loss`) на тестовом наборе.
